...
project = u'tychoish, Personal Stack'
...
html_title = 'tychoish, Personal Stack'
html_short_title = 'Stack'
...
# (source start file, target name, title, author, documentclass [howto/manual]).
  ('index', 'stack.tex', u'tychoish, Personal Stack', u'Sam Kleinman', 'howto'),
]
