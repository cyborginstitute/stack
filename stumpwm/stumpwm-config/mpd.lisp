...
(fill-keymap *mpd-map*
             ...
             (kbd "r") "mpd-toggle-random"
             (kbd "l") "mpd-toggle-repeat"
             (kbd "f") "mpd-toggle-xfade"
             (kbd "F") "mpd-set-xfade"
             (kbd "c") "mpd-current-song"
             (kbd "p") "mpd-play"
             ...
             (kbd "a") "mpd-search-and-add-artist"
             (kbd "A") "mpd-search-and-add-album"
             (kbd "s") "mpd-search-and-add-title"
             (kbd "f") "mpd-search-and-add-file"
             (kbd "z") "mpd-playlist"
...
(defcommand volume-loud ()() (run-shell-command "exec amixer -q set Master 5+ unmute"))
(defcommand volume-quiet ()() (run-shell-command "exec amixer -q set Master 5-unmute"))
(defcommand volume-toggle ()() (run-shell-command "exec amixer -q sset Master toggle"))
