...
.(defvar naquadah-colors
      '((((class color) (min-colors 65535))
       ...
       (scarlet-red-1 "#729fcf")
       (scarlet-red-2 "#AA63A8")
       (scarlet-red-3 "#6652AE")
       (scarlet-red-4 "#002240")
         (background . "#252A2B")
         (black . "#0c191C")
...
(naquadah-theme-set-faces
 ...
 '(fringe (:background black))
   ...
   `(mode-line ((t (:foreground aluminium-1 :background black
                                :box (:line-width -1 :style released-button :color aluminium-6)))))
...
(let* ((aluminium-1 "#eeeeec")
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:background ,scarlet-red-1))))
 ...
 '(spam (:background black :foreground orange-2))
   ...
   '(ido-subdir ((t (:foreground "orange-2"))))
   ...
   `(org-todo ((t (:bold t :foreground ,scarlet-red-4))))
   ...
   `(org-agenda-date-weekend ((t (:inherit 'org-agenda-date :foreground ,black :weight bold))))
   ...
   `(rst-level-1-face ((t (:foreground ,gradient-1))))
   `(rst-level-2-face ((t (:foreground ,gradient-2))))
   `(rst-level-3-face ((t (:foreground ,gradient-3))))
