...
;; URL: http://david.rysdam.org/src/emacs/highlight-sexps/
...
(defun hl-sexp-highlight ()
  ...
  (unless (= (point) hl-sexp-last-point)
    ...
    (let ((overlays hl-sexp-overlays)
		  (sexp-list (sexp-end-points (point) (length hl-sexp-overlays)))
          pos1 pos2)
	  (condition-case err
